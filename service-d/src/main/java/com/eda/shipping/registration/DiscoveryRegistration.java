package com.eda.shipping.registration;
...
/**
 * Self-registration on startup: the service announces its name, base URL and OpenAPI URL to the
 * discovery service once the application context is ready. No caller ever hardcodes this
 * service's location — the discovery service and gateway learn it dynamically from this event.
 */
@Component
